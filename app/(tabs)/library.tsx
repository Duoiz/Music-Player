...
export default function LibraryScreen() {
	...
	const renderEmpty = (title: string, subtitle: string, icon: any) => (
		<GlassCard style={styles.emptyCard} intensity="light" variant={theme.id === 'frutiger-aero' ? 'dark' : 'default'}>
			...
			<Text style={[styles.emptyTitle, theme.id === 'frutiger-aero' ? { color: 'rgba(120,230,255,0.95)', fontFamily: 'Rajdhani_600SemiBold' } : { color: theme.colors.textPrimary }]}>
				{title}
			</Text>
	...
	const renderQueue = () => (
		<>
			<View style={styles.sectionHeader}>
				<Text style={[styles.sectionTitle, { color: theme.colors.textPrimary }]}>Current Queue</Text>
				{queue.length > 0 && (
	...
	const renderDownloads = () => (
		<>
			<View style={styles.sectionHeader}>
				<Text style={[styles.sectionTitle, { color: theme.colors.textPrimary }]}>Offline Songs</Text>
			</View>
	...
	const renderPlaylists = () => {
		...
		return (
			<>
				<View style={styles.sectionHeader}>
					<Text style={[styles.sectionTitle, { color: theme.colors.textPrimary }]}>Your Playlists</Text>
